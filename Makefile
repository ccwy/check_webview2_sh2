...
RES_FILE = resource.o
LINK_CMD = $(CC) check_env.c $(RES_FILE) -o check_env.exe $(CFLAGS) $(LDFLAGS) -mwindows -ladvapi32 -lversion -lshell32 -lcomctl32
...
LINK_CMD = cl check_env.c $(RES_FILE) $(CFLAGS) $(LDFLAGS) /Fe:check_env.exe advapi32.lib version.lib shell32.lib comctl32.lib
endif
